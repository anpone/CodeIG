...
-  `CodeIgniter v3.0.2 (当前版本) <https://codeload.github.com/bcit-ci/CodeIgniter/zip/3.0.2>`_
...
CodeIgniter 可以在 `GitHub <https://github.com/bcit-ci/CodeIgniter>`_ 上公开访问。请注意，尽管我们在保持代码的基础功能上做出了大量的努力，但是我们并不能为开发分支的代码中的功能作担保。
